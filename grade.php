...
<div class="container" style="margin-top:30px">
  <div class="card">
   <div class="card-header">
      <div class="row">
        <div class="col-md-9">All courses</div>
    ...
    <form method="post" id="grade_form">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Course Credits <span class="text-danger">*</span></label>
              <div class="col-md-8">
                <input type="text" name="grade_credits" id="grade_credits" class="form-control" />
                <span id="error_grade_credits" class="text-danger"></span>
              </div>
            </div>
          </div>
        </div>
 ...
 var dataTable = $('#grade_table').DataTable({
  ...
  $('#grade_form').on('submit', function(event){
    ...
    $.ajax({
      ...
      beforeSend:function()
      {
        console.log($('#grade_form').serialize());
      ...
      success:function(data){
        ...
        { 
          if(data.error_grade_name != '')
          {
            ...
            $('#error_grade_credits').text(data.error_grade_id);
          }
          else
          {
            $('#error_grade_name').text('');
            $('#error_grade_credits').text('');
          }
        }
      }
    });
  ...
  $(document).on('click', '.edit_grade', function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        $('#grade_credits').val(data.credits);
